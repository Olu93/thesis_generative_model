...
print(__package__)
setup(
    name='thesis_generative_model',
    version='0.0.1',
    author="Olusanmi Hundogan",
    author_email="o.hundogan@gmail.com",
    description='A package that specifies and trains counterfactual generators for process mining models',
    long_description=open(CURR_DIR / 'README.md').read() + '\n\n' + open(CURR_DIR / 'CHANGELOG.md').read(),
    long_description_content_type="text/markdown",
    url='https://github.com/Olu93/thesis_generative_model',
    project_urls={
        "Bug Tracker": "https://github.com/Olu93/thesis_generative_model/issues",
    },
